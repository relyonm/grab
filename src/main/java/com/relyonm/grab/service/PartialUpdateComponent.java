 ...
 * <p>
 * Uses {@link JsonPatch} to apply the operations,
...
public class PartialUpdateComponent {
   ...
   * @param patchOperations JSON tree nodes that contain the list of JSON Patch operations to apply
  ...
  public <T> T partialUpdate(Object source,
    JsonNode patchOperations,
    Class<T> targetClass) throws IOException {
    try {
      // Convert source object into JSON tree nodes
